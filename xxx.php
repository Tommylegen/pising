...
<head>
	...
	<link rel="icon" type="png/image" href="juba.png" />
...
<body>
	<section>
		...
		<div class="wrap">
			<div class="textBox">
				<h1>Panel Setting Mediafire</h1>
				<p id="quote" style="font-size:15px;">
Maded With ❤️ By <a href="https://wa.me/62895388788567">JUBZHOSTING</a></p>
				<span id="by"></span>
			</div>
		
			   <div class="pemberitahuan" style="overflow:hidden;margin-top:10px;padding:2px;">
			  <img style="border-radius:3px;max-width:100%;" src="https://j.top4top.io/p_24241bvi60.jpg">
			  </div>
			...
			<div class="formulir" id="changeNama" style="display:none;">
				<div class="form-group">
					...
					<input type="email" id="ngNama" class="form-input" placeholder="Isi Nama Ress" autocomplete="off">
				</div>
			...
			<div class="formulir" id="changeEmail" style="display:none;">
				<div class="form-group">
					<span class="icon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
					<input type="email" id="ngEmail" class="form-input" placeholder="Isi Email Dengan Benar" autocomplete="off">
				</div>
				<div style="margin-top:10px;" class="form-group" id="otp-btn">
			...
			<div class="formulir" id="changeVideo" style="display:none;">
				<div class="form-group">
					<span class="icon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
					<input type="email" id="ngVideo" class="form-input" placeholder="Isi Nama File Mediafire" autocomplete="off">
				</div>
				<div style="margin-top:10px;" class="form-group" id="otp-btn">
			...
			<div class="formulir" id="changeUkuran" style="display:none;">
				<div class="form-group">
					<span class="icon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
					<input type="email" id="ngUkuran" class="form-input" placeholder="Isi Ukuran File Mediafire" autocomplete="off">
				</div>
				<div style="margin-top:10px;" class="form-group" id="otp-btn">
